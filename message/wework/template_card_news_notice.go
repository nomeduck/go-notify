...
func (t TemplateCardNewsNoticeMessage) I() notify.IMessage {
	t.Msgtype = "template_card"
	return &t
}

func (t *TemplateCardNewsNoticeMessage) AtMobiles(mobiles []string) {
	panic("No delivery required")
}

func (t *TemplateCardNewsNoticeMessage) AtUserIds(userIds []string) {
	panic("No delivery required")
}

func (t *TemplateCardNewsNoticeMessage) AtAll() {
	panic("No delivery required")
}
